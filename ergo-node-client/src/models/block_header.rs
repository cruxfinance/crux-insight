...
pub struct BlockHeader {
    ...
    pub pow_solutions: Box<crate::models::PowSolutions>,
    #[serde(rename = "height")]
    pub height: i32,
...
impl BlockHeader {
    pub fn new(id: String, timestamp: i64, version: i32, ad_proofs_root: String, state_root: String, transactions_root: String, n_bits: i64, extension_hash: String, pow_solutions: crate::models::PowSolutions, height: i32, difficulty: String, parent_id: String, votes: String) -> BlockHeader {
        BlockHeader {
            id,
            timestamp,
            version,
            ...
            n_bits,
            extension_hash,
            pow_solutions: Box::new(pow_solutions),
            height,
            difficulty,
            parent_id,
            votes,
