...
pub struct CommitmentWithSecret {
    #[serde(rename = "hint")]
    pub hint: Hint,
    #[serde(rename = "pubkey")]
...
impl CommitmentWithSecret {
    /// commitment to secret along with secret (!) randomness
    pub fn new(hint: Hint, pubkey: crate::models::SigmaBoolean, position: String, a: String) -> CommitmentWithSecret {
